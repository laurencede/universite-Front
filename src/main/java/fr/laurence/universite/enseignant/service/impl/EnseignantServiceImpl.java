...
public class EnseignantServiceImpl implements IEnseignantService{
		...
		public Enseignant modifierEnseignant(Enseignant modifEnseignant) {
			Integer id = modifEnseignant.getId();
			er.update(modifEnseignant, id);
			Enseignant enseignantModifier = er.getOne(id); //appel de la méthode findOne pour voir l'enseignant modifier
